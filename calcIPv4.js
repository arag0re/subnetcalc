...
class SubnetCalc {
    ...
    print() {
        console.log("Address:      " + this.convertIpv4BinStrToIpv4(this.ipv4) + "    " + this.addDots(this.ipv4));
        console.log("Netmask:      " + this.convertIpv4BinStrToIpv4(this.netmask) + "    " + this.addDots(this.netmask));
        console.log("Network:      " + this.convertIpv4BinStrToIpv4(this.network) + `/${this.netmaskInput} ` + this.addDots(this.network) + ` (Class ${this.class})`);
        console.log("Wildcard:     " + this.convertIpv4BinStrToIpv4(this.invertBinStr(this.netmask)) + "        " + this.addDots(this.invertBinStr(this.netmask)));
        console.log("Broadcast:    " + this.convertIpv4BinStrToIpv4(this.broadcast) + "  " + this.addDots(this.broadcast));
        console.log("minHost:      " + this.convertIpv4BinStrToIpv4(this.hostMin) + "    " + this.addDots(this.hostMin));
        console.log("maxHost:      " + this.convertIpv4BinStrToIpv4(this.hostMax) + "  " + this.addDots(this.hostMax));
        console.log("maxHosts/Net: " + this.hosts);
    }
...
readline.question('<IPv4>/<Netmask>', address => {
    const addressParts = address.split("/");
    let ipv4 = addressParts[0];
    let netmask = addressParts[1];
    const calc = new SubnetCalc(ipv4, netmask);
    console.log(calc.convertBinToDecimal(int32BitToByteStr(11)))
